...
HD_PWD='C:/Users/timmy/Desktop/group9_finalproject/group9_finalproject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_module.tcl -notrace
