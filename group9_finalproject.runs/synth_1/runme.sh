...
HD_PWD='C:/Users/timmy/Desktop/group9_finalproject/group9_finalproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_module.tcl
